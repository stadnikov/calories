...
<div class="jumbotron pt-4">
    ...
    <form id="filterMealForm">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-secondary" onclick="filterMealReset()">
    ...
    <table class="table table-striped" id="datatable">
        ...
        <c:forEach items="${requestScope.meals}" var="meal">
            ...
            <tr data-meal-excess="${meal.excess}" id="${meal.id}">
                ...
                <td>${meal.calories}</td>
                <td><a><span class="fa fa-pencil"></span></a><a href="meals/update?id=${meal.id}"><spring:message code="common.update"/></a></td>
