    ...
    <div class="container">
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${requestScope.users}" var="user">
                ...
                <tr id="${user.id}" enabled-user="${user.enabled}">
                    <td><c:out value="${user.name}"/></td>
                    <td><a href="mailto:${user.email}">${user.email}</a></td>
                    <td>${user.roles}</td>
                    <td><input type="checkbox" name="user-active" onchange="userActive(${user.id}, this)" <c:if test="${user.enabled}">checked</c:if>/></td>
